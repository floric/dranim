...
describe('Nodes', () => {
  test('should create and get node', () =>
  ...
  test('should create and get node in context', () =>
    doTestWithDb(async db => {
      (getWorkspace as jest.Mock).mockResolvedValue(ws);
  ...
  test('should not get invalid node', () =>
    doTestWithDb(async db => {
  ...
  test('should throw error for unknown node', () =>
    doTestWithDb(async db => {
      try {
  ...
  test('should not create node for unknown workspace', () =>
    doTestWithDb(async db => {
      try {
  ...
  test('should not create node for unknown context node', () =>
    doTestWithDb(async db => {
      (getWorkspace as jest.Mock).mockResolvedValue(ws);
  ...
  test('should create and delete node', () =>
    doTestWithDb(async db => {
      (getWorkspace as jest.Mock).mockResolvedValue(ws);
  ...
  test('should throw error when deleting node with unknown id', () =>
    doTestWithDb(async db => {
      try {
  ...
  test('should throw error when deleting context type node', () =>
    doTestWithDb(async db => {
      (getWorkspace as jest.Mock).mockResolvedValue(ws);
  ...
  test('should not delete unknown node', () =>
    doTestWithDb(async db => {
      try {
  ...
  test('should update node and change x and y', () =>
    doTestWithDb(async db => {
      (getWorkspace as jest.Mock).mockResolvedValue(ws);
  ...
  test('should throw error for invalid ID in updateNodePosition', () =>
    doTestWithDb(async db => {
      try {
  ...
  test('should throw error for invalid node type', () =>
    doTestWithDb(async db => {
      (getWorkspace as jest.Mock).mockResolvedValue(ws);
  ...
  test('should throw error for output node in context', () =>
    doTestWithDb(async db => {
      (getWorkspace as jest.Mock).mockResolvedValue(ws);
  ...
  test('should create node and nested context nodes', () =>
    doTestWithDb(async db => {
      (getWorkspace as jest.Mock).mockResolvedValue(ws);
      (updateStates as jest.Mock).mockResolvedValue({});
  ...
  test('should delete connection infos on nodes', () =>
    doTestWithDb(async db => {
      (getWorkspace as jest.Mock).mockResolvedValue(ws);
  ...
  test('should delete all context nodes and connections', () =>
    doTestWithDb(async db => {
      (getWorkspace as jest.Mock).mockResolvedValue(ws);
  ...
  test('should delete all nested context nodes and connections', () =>
    doTestWithDb(async db => {
      (getWorkspace as jest.Mock).mockResolvedValue(ws);
  ...
  test('should return null for node without context', () =>
    doTestWithDb(async db => {
      (getWorkspace as jest.Mock).mockResolvedValue(ws);
  ...
  test('should try to get context node', () =>
    doTestWithDb(async db => {
      (getWorkspace as jest.Mock).mockResolvedValue(ws);
  ...
  test('should throw error for unknown context node', () =>
    doTestWithDb(async db => {
      try {
