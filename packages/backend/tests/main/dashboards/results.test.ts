...
describe('Dashboard Results', () => {
  ...
  test('should throw error for empty names', () =>
    doTestWithDb(async db => {
      try {
  ...
  test('should throw error for unknown workspace', () =>
    doTestWithDb(async db => {
  ...
  test('should delete result by id', () =>
    doTestWithDb(async db => {
      const value: NodeOutputResult<string> = {
        description: 'desc',
        name: 'test',
  ...
  test('should delete result by workspace id', () =>
    doTestWithDb(async db => {
      const value: NodeOutputResult<string> = {
        description: 'desc',
        name: 'test',
  ...
  test('should return null for unknown results', () =>
    doTestWithDb(async db => {
  ...
  test('should delete result by name', () =>
    doTestWithDb(async db => {
      const value: NodeOutputResult<string> = {
        description: 'desc',
        name: 'test',
  ...
  test('should throw error for unknown name', () =>
    doTestWithDb(async db => {
      try {
  ...
  test('should throw error for unknown id', () =>
    doTestWithDb(async db => {
      try {
  ...
  test('should get only results for correct workspace', () =>
    doTestWithDb(async db => {
      const value: NodeOutputResult<string> = {
        description: 'desc',
        name: 'test',
  ...
  test('should throw error for unknown result', () =>
    doTestWithDb(async db => {
      try {
  ...
  test('should try and get result', () =>
    doTestWithDb(async db => {
  ...
  test('should set result visibility', () =>
    doTestWithDb(async db => {
  ...
  test('should get public results', () =>
    doTestWithDb(async db => {
