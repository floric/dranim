...
export default class StartPage extends React.Component<{}> {
  private renderCreateExampleButton = (type: string) => (
        ...
        <Row gutter={8}>
          <Col sm={24} md={12} lg={8}>
            <Card bordered={false}>
              ...
              {this.renderCreateExampleButton('STR')}
              <Divider />
              <h3>Birthdays</h3>
              <p>
